...
class StoreApprovalWorkflowRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'steps.*.approver_role_id' => [
                'nullable',
                'integer',
                Rule::exists('roles', 'id')->where('organization_id', $this->user()?->organization_id),
            ],
            'steps.*.approver_permission' => ['nullable', 'string', 'max:255', Rule::exists('permissions', 'name')],
